...
var ItemComponent = /** @class */ (function () {
    ...
    ItemComponent.prototype.addArticle = function () {
        var _this = this;
        this.orderService.getAllergens().then(function (data) {
            console.log('data', data);
            _this.allergens = data.data;
        })
            .catch(function (error) {
