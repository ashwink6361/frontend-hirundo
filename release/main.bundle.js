            ...
            for (var i = 0; i < _this._orders.length; i++) {
                if (data.id === _this._orders[i]._id) {
                    ...
                    if (userType == 3) {
                        ...
                        var sts = [];
                        if (temp && temp.item) {
                            for (var j_1 = 0; j_1 < temp.item.length; j_1++) {
                                for (var k_1 = 0; k_1 < data.step.length; k_1++) {
                                    if (((temp.item[j_1].department.indexOf(_this.authGuard.getCurrentUser()._id)) > -1) || ((_this.authGuard.getCurrentUser().category.indexOf(temp.item[j_1].category)) > -1)) {
                                        if (temp.item[j_1].step == data.step[k_1].step) {
                        ...
                        if (data && data.orderData.item) {
                            for (var j_2 = 0; j_2 < data.orderData.item.length; j_2++) {
                                if (((data.orderData.item[j_2].department.indexOf(_this.authGuard.getCurrentUser()._id)) > -1) || ((_this.authGuard.getCurrentUser().category.indexOf(data.orderData.item[j_2].category)) > -1)) {
                                    itemsTemp.push(data.orderData.item[j_2]);
                                }
                            }
                        }
                        temp.item = itemsTemp;
        ...
        return this.http.post(url, opts).toPromise()
            ...
            for (var i = 0; i < _this._orders.length; i++) {
                ...
                if (_this._orders[i] && _this._orders[i].item) {
                    for (var j_3 = 0; j_3 < _this._orders[i].item.length; j_3++) {
                        if (((_this._orders[i].item[j_3].department.indexOf(_this.authGuard.getCurrentUser()._id)) > -1) || ((_this.authGuard.getCurrentUser().category.indexOf(_this._orders[i].item[j_3].category)) > -1)) {
                            itemsTemp.push(_this._orders[i].item[j_3]);
                        }
                    }
                }
                temp.item = itemsTemp;
            ...
            for (var i = 0; i < _this._orders.length; i++) {
                if (res._id === _this._orders[i]._id) {
                    ...
                    if (res && res.orderData.item) {
                        for (var j_4 = 0; j_4 < res.orderData.item.length; j_4++) {
                            if (((res.orderData.item[j_4].department.indexOf(_this.authGuard.getCurrentUser()._id)) > -1) || ((_this.authGuard.getCurrentUser().category.indexOf(res.orderData.item[j_4].category)) > -1)) {
                                itemsTemp.push(_this._orders[i].item[j_4]);
                            }
                        }
                    }
                    temp.item = itemsTemp;
