...
// module
exports.push([module.i, ".page-content-header {\n  padding: 0; }\n  .page-content-header .back-btn {\n    color: #fff; }\n    .page-content-header .back-btn a {\n      color: #fff;\n      font-size: 40px;\n      padding: 0px 25px; }\n      .page-content-header .back-btn a:hover {\n        color: #fff; }\n  .page-content-header .header-title {\n    color: #fff;\n    font-size: 20px; }\n", ""]);
...
var CreateOrderComponent = /** @class */ (function () {
    ...
    CreateOrderComponent.prototype.ngOnInit = function () {
        ...
        this.createOrderService.getCategory()
            ...
            if (_this.categoryList.length) {
                ...
                console.log('this.categorySearchData', _this.categorySearchData);
    ...
    CreateOrderComponent.prototype.showItems = function (id, name) {
        var _this = this;
        var obj = {
            _id: id,
            name: name
        ...
        if (this.selectedCategory) {
            ...
            this.createOrderService.getCategoryItem().then(function (data) {
                ...
                console.log('this.categoryItems', _this.categoryItems);
            })
                .catch(function (error) {
                console.log('error', error);
            });
