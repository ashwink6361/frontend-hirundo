            ...
            if (_this.orders.length) {
                for (var i = 0; i < _this.orders.length; i++) {
                    ...
                    for (var k = 0; k < _this.steps[_this.orders[i]._id].length; k++) {
                        ...
                        delivered[_this.steps[_this.orders[i]._id][k]] = false;
                        call[_this.steps[_this.orders[i]._id][k]] = false;
                        remtime[_this.steps[_this.orders[i]._id][k]] = '0:00';
                    ...
                    console.log('this.showDeliveredButton', _this.showDeliveredButton);
                    ...
                    console.log('this.remainingTime', _this.remainingTime);
                }
