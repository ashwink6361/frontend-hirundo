    ...
    OrderListComponent.prototype.updateOrder = function (order, time, status) {
        ...
        var id = setInterval(function () {
            ...
            if (mlSeconds < 0) {
                ...
                width++;
                if (mlSeconds > 0)
                    _this.remainingTime = (mlSeconds) / 60 * 1000;
