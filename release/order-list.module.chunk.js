...
var OrderListComponent = /** @class */ (function () {
    ...
    OrderListComponent.prototype.updateDepartmentStatus = function (order, step) {
        var opts = {
            step: step
        };
