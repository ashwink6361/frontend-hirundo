...
var ListComponent = /** @class */ (function () {
    ...
    ;
    ListComponent.prototype.updateOrder = function (item, order, status) {
        item.status = status;
        var items = [];
